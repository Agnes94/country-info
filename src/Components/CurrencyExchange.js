...
const URL =
  "https://free.currconv.com/api/v7/convert?compact=ultra&apiKey=c6f15ce60765fe470ecb";

export const CurrencyExchange = (props) => {
  const { currencyOfCountry } = props;
  ...
  return (
    <>
      ...
      <input className="currency-input" type="number" value={toAmount} />
      <span>{currencyOfCountry}</span>
    </>
  );
};